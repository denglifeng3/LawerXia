...
public class ShiroConfiguration {
    Map<String,String> filterChainDefinitionMap= Collections.synchronizedMap(new LinkedHashMap<String, String>());
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean() {
        ...
        shiroFilter.put("00",new KickoutSessionControlFilter(getDefaultWebSecurityManager(),getEhCacheManager()));
