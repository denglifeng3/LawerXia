 ...
 */
public class ShiroFilterFactoryBeanLawer extends ShiroFilterFactoryBean{
    // 对ShiroFilter来说，需要直接忽略的请求
    private Set<String> ignoreExt;
    private DefaultWebSecurityManager securityManager;

    public ShiroFilterFactoryBeanLawer(Object securityManager) {
        super();
    ...
    protected AbstractShiroFilter createInstance() throws Exception {
        ...
        //SecurityManager securityManager =shiroConfiguration.getDefaultWebSecurityManager();
